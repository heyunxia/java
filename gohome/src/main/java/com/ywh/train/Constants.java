...
public class Constants {
    ...
    public static String LOGIN_CODE_URL_OLD     = "https://dynamic.12306.cn/otsweb/passCodeAction.do?rand=sjrand";
    public static String LOGIN_CODE_URL = "https://kyfw.12306.cn/otn/passcodeNew/getPassCodeNew?module=login&rand=sjrand&";
    public static String RANDSTR_URL = "https://dynamic.12306.cn/otsweb/loginAction.do?method=loginAysnSuggest";
    public static String LOGIN_URL = "https://dynamic.12306.cn/otsweb/loginAction.do?method=login";
    public static String BOOK_URL = "https://dynamic.12306.cn/otsweb/order/querySingleAction.do?method=submutOrderRequest";
    public static String ORDER_CODE_URL = "https://dynamic.12306.cn/otsweb/passCodeAction.do?rand=randp";

    public static String SUBMIT_URL_CHECK = "https://dynamic.12306.cn/otsweb/order/confirmPassengerAction.do?method=checkOrderInfo";
    public static String SUBMIT_URL_CONFIRM = "https://dynamic.12306.cn/otsweb/order/confirmPassengerAction.do?method=confirmSingleForQueueOrder";
    ...
    public static Map<String, String> trainRang = new TreeMap();
    public static Map<String, String> cardType = new TreeMap();
    public static Map<String, String> ticketType = new TreeMap();
    public static Map<String, String> seatPos = new TreeMap();
    ...
    static {
        trainPriorityMap.put(TRAIN_L, Integer.valueOf(40));
        trainPriorityMap.put(TRAIN_K, Integer.valueOf(50));
        trainPriorityMap.put(TRAIN_T, Integer.valueOf(60));
        trainPriorityMap.put(TRAIN_Z, Integer.valueOf(70));
        trainPriorityMap.put(TRAIN_D, Integer.valueOf(71));
        trainPriorityMap.put(TRAIN_G, Integer.valueOf(80));

        trainSeatMap.put("有", Integer.valueOf(1000));
        trainSeatMap.put("无", Integer.valueOf(0));
        trainSeatMap.put("--", Integer.valueOf(-1));
        trainSeatMap.put("*", Integer.valueOf(-1));
    ...
    public static String[] getSeatPosType() {
        return new String[]{"默认", "下铺", "中铺", "上铺"};
    }
    ...
    public static void setTrainPriority(String key, int value) {
        trainPriorityMap.put(key, Integer.valueOf(value));
    }

    public static String getTrainSeatName(String key) {
        return (String) trainSeatNameMap.get(key);
    }

    public static String getTrainRang(String key) {
        return (String) trainRang.get(key);
    }
}